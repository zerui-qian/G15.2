...
sys.path.append(r'E:\G15.2_scripts\base\experiment_base')
sys.path.append(r'E:\G15.2_scripts\base\experiment_base\zq_drivers')
...
if __name__ == "__main__":
    ...
    #                 (SCx, np.linspace(90, 40, 51)),
    #                 (SCy, np.linspace(50, 100, 51)),
