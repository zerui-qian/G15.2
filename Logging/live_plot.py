...
class PlotWindow(QtWidgets.QMainWindow):
    def __init__(self, title, xlabel, ylabel):
        ...
        self.plot_graph.setBackground((79, 64, 69))
        self.plot_graph.setTitle(title, color = (246, 241, 238), size = "24pt", bold = True)
        styles = {"color": "red", "font-size": "22pt"}
        ...
        x_axis.setTickPen(color = (246, 241, 238))
        x_axis.setTextPen(color = (246, 241, 238))
        x_axis.setPen(color=(246, 241, 238), width = 3)
        y_axis.setTickFont(font)
        y_axis.setTickPen(color = (246, 241, 238))
        y_axis.setTextPen(color = (246, 241, 238))
        y_axis.setPen(color=(246, 241, 238), width = 3)

        pen = pg.mkPen((237, 125, 49), width=3, style=QtCore.Qt.DotLine)
