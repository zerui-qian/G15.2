...
# base_folder = 'Z:/Projects/ODMR/ODMR_data\\'
date = '2025-03-27'  # Specify the date in yyyy-mm-dd format
...
for i in index:
    ...
    if measurement == 'spectrum':
        # fig = plottingFunctions.plot_spectrum(data_file, xlim=(1.56,2.03))
        fig = plottingFunctions.plot_spectrum_official(data_file, xlim=(1.2,2.3))
    elif measurement == 'APD_scan' or 'APD_scan_attocube':
        # fig = plottingFunctions.plot_APDscan(data_file, size=(14,6), clip=False, clipNumber=1400)
        fig = plottingFunctions.plot_APDscan_official(data_file, size=(7,6), clip=False, clipNumber=1400)
        ...
        fig = plottingFunctions.plot_angles(data_file, ymin=23000)
